...
public class ModEnchantments {
	...
	public static final RegistryObject<Enchantment> ENCHANTMENT_MULTISHOT = VANILLA_ENCHANTMENTS.register("multishot", () -> {
		return (CrossbowverhaulConfigHolder.coModMultishot != null && CrossbowverhaulConfigHolder.coModMultishot.get() > 1) ? new MultishotEnchantment(Enchantment.Rarity.RARE, EquipmentSlotType.MAINHAND) : Enchantments.MULTISHOT;
	});
