...
public class ModEnchantments {
	...
	public static final RegistryObject<Enchantment> ENCHANTMENT_MULTISHOT = VANILLA_ENCHANTMENTS.register("multishot", () -> new MultishotEnchantment(Enchantment.Rarity.RARE, EquipmentSlotType.MAINHAND));
