...
public class ModItems {
	...
	//Netherite crossbow
	public static final RegistryObject<Item> ITEM_CROSSBOW_NETHERITE = ITEMS.register("crossbow_netherite", () -> (new ItemCrossbowNetherite(new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_COMBAT).durability(1024).fireResistant())));
